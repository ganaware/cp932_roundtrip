...
$uni_to_cp932 =
  [
   ...
   UniToCp932.new("Win32<br>without<br>WC_NO_<br>BEST_<br>FIT_<br>CHARS",
                  ...
                  "utf16_to_cp932-win32.cpp",
                  "reference-end"),
   UniToCp932.new("Perl<br>5.10.1",
                  "result/utf16_to_cp932-perl_5.10.1-macports_1.8.2.txt",
                  "utf16_to_cp932.pl",
                  nil),
   UniToCp932.new("Ruby<br>1.9.1<br>_p376",
                  "result/utf16_to_cp932-ruby_1.9.1p376-macports_1.8.2.txt",
                  "utf16_to_cp932.rb",
                  nil),
   ...
   UniToCp932.new("glibc<br>2.7",
                  ...
                  "utf16_to_cp932-libiconv.cpp",
                  nil),
   UniToCp932.new("Java<br>1.6.0<br>_17",
                  "result/utf16_to_cp932-java_1.6.0_17-osx_10.6.2.txt",
                  "utf16_to_cp932.java",
                  nil),
   ...
   UniToCp932.new("apr-<br>iconv<br>1.2.1<br>+<br><a href=\"apr-iconv-1.2.1-cp932-patch2.txt\">cp932<br>patch2</a>",
                  ...
                  "utf16_to_cp932-apriconv.cpp",
                  nil),
   UniToCp932.new("Python<br>2.7a3<br>+<br><a href=\"Python-2.7a3-cp932-patch.txt\">cp932<br>patch</a>",
                  "result/utf16_to_cp932-python_2.7a3+cp932_patch.txt",
                  "utf16_to_cp932.py",
                  nil),
   UniToCp932.new("Python<br>2.7a3<br>+<br><a href=\"Python-2.7a3-cp932-patch2.txt\">cp932<br>patch2</a>",
                  "result/utf16_to_cp932-python_2.7a3+cp932_patch2.txt",
                  "utf16_to_cp932.py",
                  nil),
   UniToCp932.new("PHP<br>5.3.3<br>(mb_<br>convert)",
                  "result/utf16_to_cp932-php_5.3.3-macports_10.6.4.txt",
                  "utf16_to_cp932.php",
                  nil),
   ...
   UniToCp932.new("apr-<br>iconv<br>1.2.1",
                  ...
                  "utf16_to_cp932-apriconv.cpp",
                  nil),
   UniToCp932.new("Python<br>2.6.4",
                  "result/utf16_to_cp932-python_2.6.4-macports_1.8.2.txt",
                  "utf16_to_cp932.py",
                  nil),
   UniToCp932.new("PHP<br>5.3.0<br>(mb_<br>convert)",
                  "result/utf16_to_cp932-php_5.3.0-osx_10.6.2.txt",
                  "utf16_to_cp932.php",
                  nil),
  ]
...
$cp932_to_uni =
  [
   Cp932ToUni.new("Win32",
                  ...
                  "reference-end"),
   Cp932ToUni.new("Perl<br>5.10.1",
                  "result/cp932_to_utf16-perl_5.10.1-macports_1.8.2.txt",
                  "cp932_to_utf16.pl",
                  nil),
   Cp932ToUni.new("Ruby<br>1.9.1<br>_p376",
                  "result/cp932_to_utf16-ruby_1.9.1p376-macports_1.8.2.txt",
                  "cp932_to_utf16.rb",
                  nil),
   ...
   Cp932ToUni.new("glibc<br>2.7",
                  ...
                  "cp932_to_utf16-libiconv.cpp",
                  nil),
   Cp932ToUni.new("Java<br>1.6.0<br>_17",
                  "result/cp932_to_utf16-java_1.6.0_17-osx_10.6.2.txt",
                  "cp932_to_utf16.java",
                  nil),
   ...
   Cp932ToUni.new("apr-<br>iconv<br>1.2.1<br>+<br><a href=\"apr-iconv-1.2.1-cp932-patch2.txt\">cp932<br>patch2</a>",
                  ...
                  "cp932_to_utf16-apriconv.cpp",
                  nil),
   Cp932ToUni.new("PHP<br>5.3.3<br>(mb_<br>convert)",
                  "result/cp932_to_utf16-php_5.3.3-macports_10.6.4.txt",
                  "cp932_to_utf16.php",
                  nil),
   ...
   Cp932ToUni.new("apr-<br>iconv<br>1.2.1",
                  ...
                  "cp932_to_utf16-apriconv.cpp",
                  nil),
   Cp932ToUni.new("Python<br>2.6.4",
                  "result/cp932_to_utf16-python_2.6.4-macports_1.8.2.txt",
                  "cp932_to_utf16.py",
                  nil),
   Cp932ToUni.new("PHP<br>5.3.0<br>(mb_<br>convert)",
                  "result/cp932_to_utf16-php_5.3.0-osx_10.6.2.txt",
                  "cp932_to_utf16.php",
                  nil),
  ]
