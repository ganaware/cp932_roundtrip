...
$uni_to_cp932 =
  [
   ...
   UniToCp932.new("apr-<br>iconv<br>1.2.1",
                  ...
                  "utf16_to_cp932-apriconv.cpp",
                  nil),
   UniToCp932.new("Python<br>2.7.1",
                  "result/utf16_to_cp932-python_2.7.1-osx_10.7.1.txt",
                  "utf16_to_cp932.py",
                  nil),
  ]
...
$cp932_to_uni =
  [
   ...
   Cp932ToUni.new("apr-<br>iconv<br>1.2.1",
                  ...
                  "cp932_to_utf16-apriconv.cpp",
                  nil),
   Cp932ToUni.new("Python<br>2.7.1",
                  "result/cp932_to_utf16-python_2.7.1-osx_10.7.1.txt",
                  "cp932_to_utf16.py",
                  nil),
  ]
