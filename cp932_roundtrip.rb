...
$uni_to_cp932 =
  [
   ...
   UniToCp932.new("apr-<br>iconv<br>1.2.1<br>+<br><a href=\"apr-iconv-1.2.1-cp932-patch2.txt\">cp932<br>patch2</a>",
                  ...
                  "utf16_to_cp932-apriconv.cpp",
                  nil),
   UniToCp932.new("Python<br>2.7.2,<br>3.2.1<br>+<br><a href=\"Python-3.2.1-cp932-patch.txt\">cp932<br>patch</a>",
                  "result/utf16_to_cp932-python_3.2.1+cp932_patch.txt",
                  "utf16_to_cp932.py",
                  nil),
   UniToCp932.new("Python<br>2.7.2,<br>3.2.1<br>+<br><a href=\"Python-3.2.1-cp932-patch2.txt\">cp932<br>patch2</a>",
                  "result/utf16_to_cp932-python_3.2.1+cp932_patch2.txt",
                  "utf16_to_cp932.py",
                  nil),
   UniToCp932.new("PHP<br>5.3.8<br>(mb_<br>convert)",
                  "result/utf16_to_cp932-php_5.3.8-osx_10.7.1.txt",
                  "utf16_to_cp932.php",
                  nil),
   ...
   UniToCp932.new("apr-<br>iconv<br>1.2.1",
                  ...
                  "utf16_to_cp932-apriconv.cpp",
                  nil),
   UniToCp932.new("Python<br>2.7.2,<br>3.2.1",
                  "result/utf16_to_cp932-python_3.2.1-osx_10.7.1.txt",
                  "utf16_to_cp932.py",
                  nil),
  ]
...
$cp932_to_uni =
  [
   ...
   Cp932ToUni.new("apr-<br>iconv<br>1.2.1<br>+<br><a href=\"apr-iconv-1.2.1-cp932-patch2.txt\">cp932<br>patch2</a>",
                  ...
                  "cp932_to_utf16-apriconv.cpp",
                  nil),
   Cp932ToUni.new("PHP<br>5.3.8<br>(mb_<br>convert)",
                  "result/cp932_to_utf16-php_5.3.8-osx_10.7.1.txt",
                  "cp932_to_utf16.php",
                  nil),
   ...
   Cp932ToUni.new("apr-<br>iconv<br>1.2.1",
                  ...
                  "cp932_to_utf16-apriconv.cpp",
                  nil),
   Cp932ToUni.new("Python<br>2.7.2,<br>3.2.1",
                  "result/cp932_to_utf16-python_3.2.1-osx_10.7.1.txt",
                  "cp932_to_utf16.py",
                  nil),
  ]
